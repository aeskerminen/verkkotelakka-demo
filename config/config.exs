...
config :verkkotelakka_demo,
  ecto_repos: [VerkkotelakkaDemo.Repo],
...
config :verkkotelakka_demo, VerkkotelakkaDemoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: VerkkotelakkaDemoWeb.ErrorHTML, json: VerkkotelakkaDemoWeb.ErrorJSON],
    layout: false
  ],
...
config :verkkotelakka_demo, VerkkotelakkaDemo.Mailer, adapter: Swoosh.Adapters.Local
