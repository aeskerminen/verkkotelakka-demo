defmodule VerkkotelakkaDemo.Application do
  ...
  def start(_type, _args) do
    children = [
      VerkkotelakkaDemoWeb.Telemetry,
      ...
      VerkkotelakkaDemoWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: VerkkotelakkaDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    VerkkotelakkaDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
